...
const CartDropdown = ({
  ...
  return (
    <Popover open={state} onOpenChange={toggle}>
      <PopoverTrigger
        render={(props) => (
          <Button {...props} variant="ghost" size="sm" data-testid="nav-cart-link">
            <ShoppingCartIcon className="block xsmall:hidden size-4" />
            <span className="hidden xsmall:block">Cart </span>{`(${totalItems})`}
          </Button>
        )}
      />
